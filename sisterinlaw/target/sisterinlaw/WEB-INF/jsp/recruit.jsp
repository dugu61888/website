	...
	<div class="m">
		<div class="head">
			<div>
				<h1>公司名称</h1>
				<h4>简短介绍</h4>
				<h4 ><a href="subintrol" style="text-decoration:none;">纳豆系类</a></h4>
			</div>
		</div>
	</div>
	<div class="m">
		<div class="banner">
			<div id="slide_banner_fix"
				...
				<a href="javascript:void(0);" target="" id="slide_banner_url"> <img
					style="display: inline;" src="../pic/1.png"
					...
					<td id="main" valign="top">
						...
						<div class="main_body">
							<div class="lh18 px13 pd10">
								<img src="../imgs/11-06-16-68-64.jpg"
									style="margin: 5px 0 5px 10px; padding: 5px; border: #C0C0C0 1px solid;"
									align="right"> 公司详细介绍
									<div class="c_b"></div>
							</div>
						</div>
...
<div id="elite" style="height:180px;overflow:hidden;">
	...
	<div class="m">
	<div class="main_body">
	<a href="http://www.baidu.com">诚聘英才</a>
	</div>
